export const en = {
  ...
  'settings.defaultCwd': 'Default start path',
  'settings.defaultCwdDesc': 'Working directory for new shells',
  'settings.defaultCwdPlaceholder': 'Empty uses home directory',
