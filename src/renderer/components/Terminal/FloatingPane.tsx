...
export default function FloatingPane() {
  ...
  useEffect(() => {
    ...
    window.electronAPI.pty.create(withDefaultPtyOptions({}, defaultShell, defaultCwd)).then((result: { id: string }) => {
      setFloatingPanePtyId(result.id);
      creatingRef.current = false;
    }).catch(() => {
      creatingRef.current = false;
    });
  }, [defaultShell, defaultCwd, floatingPaneVisible, floatingPanePtyId, setFloatingPanePtyId]);
